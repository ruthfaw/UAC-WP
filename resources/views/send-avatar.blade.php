...
<div class="d-flex justify-content-center gap-4">
    <a class="btn btn-prim" href="/sent-avatar/{{$friendId}}-id" role="button" style="margin-top: 30px; margin-bottom: 25px; padding: 5px 80px;">Bahasa</a>
    <a class="btn btn-prim" href="/sent-avatar/{{$friendId}}-en" role="button" style="margin-top: 30px; margin-bottom: 25px; padding: 5px 80px;">English</a>
</div>
        ...
        @foreach($avatars as $avatar)
            <div class="card w-100 shadow bg-white rounded">
                <div class="row g-0 m-4">
                    ...
                    <div class="col-md-7">
                        <div class="card-body">
                            <h4 class="card-title">{{$avatar->name_avatar}}</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 d-flex flex-column align-items-end justify-content-center">
                        ...
                        <div class="row manage-btn g-1">
                            <div class="col">
                                <form action="/send-purchase-avatar" method="post">
                                    @csrf
