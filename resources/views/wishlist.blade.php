...
<div class="d-flex justify-content-center gap-4">
    <a class="btn btn-prim" href="/wishlist/id" role="button" style="margin-top: 30px; margin-bottom: 25px; padding: 5px 80px;">Bahasa</a>
    <a class="btn btn-prim" href="/wishlist/en" role="button" style="margin-top: 30px; margin-bottom: 25px; padding: 5px 80px;">English</a>
</div>
<div class="wishlist" style="padding-bottom: 50px;min-height:73vh;">
    <div class="container d-flex flex-column align-items-center gap-2 mt-4" style="color: #141a47;">
        <h1>@lang('wishlist.title.wl')</h1>
        
        @if(empty($friends))
           <h2 style="margin-top:30px;color:rgb(184, 176, 176)">@lang('wishlist.emptytxt_wl')</h2>
        @endif
        
        @for ($i = 0; $i < count($friends); $i++)
            <a href="/details/{{$friends[$i]->id}}-1-en" class="card w-100 shadow bg-white rounded" style="text-decoration:none;color:#1c3879;">
                            ...
                            <div class="col">
                                <form action="/remove-wishlist" method="post">
                                    ...
                                    <div class="button" style="margin-top:10px;">
                                        <button type="submit" class="btn" style="height: 35px; width: 105px">@lang('wishlist.bar.remove_bt')</button>
                                    </div>
                                </form>
                            </div>
                        </div>
